 ...
 * Choose from Guitar, Bass, Ukulele
* Adjust the number of frets
* See all notes on the fretboard
* Show multiple - one note everywhere on the fretboard
* Adjust and reset tuning of strings
* Play a game: indicate randomly selected notes and earn points on 3 difficulty levels - Easy (15 seconds), Medium (10 seconds), Hard (5 seconds)
